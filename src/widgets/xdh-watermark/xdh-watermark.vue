<template>
  <div class='xdh-watermark' :class="{'is-mask':mask}" :style="styles">
    <slot></slot>
    <canvas ref="canvas"
            :width="width"
            :height="height"
            style="display:none"></canvas>
    <div v-if="mask" class="xdh-watermark__mask" :style="maskStyle"></div>
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    computed: {
      styles() {
        if (!this.dataUrl || this.mask) return null
